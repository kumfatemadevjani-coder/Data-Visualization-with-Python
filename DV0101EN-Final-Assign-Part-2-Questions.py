...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={'textAlign':'center','color':'#503D36','size':'24'}),#Include style for title
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = recession_data.groupby('Vehicle_Type')['Advertising_Expenditure'].sum().reset_index()                 
        R_chart2  = dcc.Graph(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        # Return the charts in the specified grid layout
        return [
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    # Check for Yearly Statistics.                             
        ...
        # Plot 1: Yearly Average Automobile Sales using line chart for the whole period
        ...
        # Return the charts in the 2x2 grid layout
        return [
